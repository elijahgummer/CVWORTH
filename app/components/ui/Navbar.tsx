        ...
        <div className="flex items-center">
          ...
          {!userId && (
            <>
              <Link
                href="../sign-in/page"
                className="text-lg text-gray-300 hover:text-white mr-4 relative rounded-6 px-12 py-6 text-body-small-medium transition-colors before:inside-border hover:before:border-transparent active:translate-y-[0.5px] active:before:border-transparent before:border-neutral-opaque-10 hover:bg-neutral-opaque-10 active:bg-[#1D3E7A24]"
              >
                Sign In
              </Link>
